...
ensure_env_value MINIO_ROOT_USER "messenger-minio"
ensure_env_value MINIO_ROOT_PASSWORD "$(random_base64_secret)"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_ENDPOINT "http://minio:9000"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_PUBLIC_ENDPOINT "${normalized_base_url}/storage"

minio_root_user="$(env_file_value MINIO_ROOT_USER)"
minio_root_password="$(env_file_value MINIO_ROOT_PASSWORD)"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_ACCESS_KEY "$minio_root_user"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_SECRET_KEY "$minio_root_password"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_BUCKET "message-attachments"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_REGION "us-east-1"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_PATH_STYLE_ACCESS "true"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_AUTO_CREATE_BUCKET "true"
ensure_env_value APP_MEDIA_MESSAGE_ATTACHMENTS_MINIO_PRESIGNED_URL_TTL "PT10M"
ensure_env_value APP_MESSAGES_CONTENT_ENCRYPTION_PROVIDER "aws-kms"
ensure_env_value APP_MESSAGES_CONTENT_ENCRYPTION_DEK_CACHE_TTL "PT10M"
ensure_env_value APP_MESSAGES_CONTENT_ENCRYPTION_AWS_KMS_KEY_ID "CHANGE_ME"
ensure_env_value APP_MESSAGES_CONTENT_ENCRYPTION_AWS_REGION "us-east-1"

ensure_env_value APP_MAIL_ENABLED "false"
...
ensure_env_value ENABLE_DBVIEWER "false"
ensure_env_value PGWEB_AUTH_USER "tester"
ensure_env_value PGWEB_AUTH_PASS "$(random_base64_secret)"
ensure_env_value PGWEB_TESTER_DB_PASSWORD ""
ensure_env_value ENABLE_OBSERVABILITY_STACK "false"
ensure_env_value MANAGEMENT_TRACING_ENABLED "false"
ensure_env_value ENABLE_LOCAL_JITSI "false"
